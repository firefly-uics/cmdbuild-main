(function() {
	...
	Ext.define("CMDBuild.view.management.dataView.filter.panel.form.tabs.masterDetail.CMCardGridDelegate", {
	...
	Ext.define("CMDBuild.view.management.dataView.filter.panel.form.tabs.masterDetail.CMCardGridPagingBar", {
	...
	/**
	 * @merged CMDBuild.view.management.common.CMCardGrid
	 */
	Ext.define("CMDBuild.view.management.dataView.filter.panel.form.tabs.masterDetail.GridPanel", {
		...
		CLASS_COLUMN_DATA_INDEX: 'IdClass_value', // for the header configuration the name is used for the server-side sorting
		...
		constructor: function(c) {
			this.mixins.delegable.constructor.call(this, "CMDBuild.view.management.dataView.filter.panel.form.tabs.masterDetail.CMCardGridDelegate");
	...
	function buildPagingBar(me) {
		...
		me.pagingBar = Ext.create('CMDBuild.view.management.dataView.filter.panel.form.tabs.masterDetail.CMCardGridPagingBar', {
			grid: me,
			store: me.store,
			displayInfo: true,
					...
					items: [
						Ext.create('CMDBuild.core.buttons.icon.Graph', {
							...
							handler: function(grid, rowIndex, colIndex, node, e, record, rowNode) {
								this.delegate.controllerWindowGraph.cmfg('onPanelGridAndFormGraphWindowConfigureAndShow', {
