(function () {
	 ...
	 * @legacy
	 */
	Ext.define("CMDBuild.view.management.dataView.filter.panel.form.tabs.card.FormPanel", {
			...
			this.cmTBar = [
				this.modifyCardButton = Ext.create('CMDBuild.core.buttons.icon.modify.Modify', {
					...
					handler: function (button, e) {
						this.delegate.parentDelegate.cmfg('onDataViewFilterModifyButtonClick');
					}
				}),
				...
				CMDBuild.configuration.graph.get(CMDBuild.core.constants.Proxy.ENABLED) ? this.graphButton = Ext.create('CMDBuild.core.buttons.icon.RelationGraph', {
					...
					handler: function(button, e) {
						this.delegate.onShowGraphClick();
					}
				}) : null,
		...
		buildButtons: function () {
			this.cmButtons = [
				this.saveButton = Ext.create('CMDBuild.core.buttons.text.Save', {
					...
					handler: function (button, e) {
						this.delegate.parentDelegate.cmfg('onDataViewFilterFormSaveButtonClick');
					}
				}),
				this.cancelButton = Ext.create('CMDBuild.core.buttons.text.Abort', {
					...
					handler: function (button, e) {
						this.delegate.parentDelegate.cmfg('onDataViewFilterAbortButtonClick');
					}
				})
			];
		},
