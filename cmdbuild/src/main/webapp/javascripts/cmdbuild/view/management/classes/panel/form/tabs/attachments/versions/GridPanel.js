(function() {
	...
	Ext.define('CMDBuild.view.management.classes.panel.form.tabs.attachments.versions.GridPanel', {
						...
						items: [
							Ext.create('CMDBuild.core.buttons.iconized.Download', {
								...
								handler: function (grid, rowIndex, colIndex, node, e, record, rowNode) {
									this.delegate.cmfg('onClassesFormTabAttachmentsVersionsDownloadButtonClick', record);
								}
							})
						]
					})
				],
				store: CMDBuild.proxy.management.classes.panel.form.tabs.attachments.Attachments.getStoreVersions()
			});
