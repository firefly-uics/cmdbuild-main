(function () {
	...
	/**
	 * @deprecated CMDBuild.view.common.panel.gridAndForm.panel.common.filter.advanced.saveDialog.FormPanel
	 */
	Ext.define('CMDBuild.view.common.filter.advanced.saveDialog.FormPanel', {
