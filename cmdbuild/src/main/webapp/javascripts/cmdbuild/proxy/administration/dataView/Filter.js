(function () {
	...
	Ext.define('CMDBuild.proxy.administration.dataView.Filter', {

		requires: [
			'CMDBuild.core.constants.Global',
			'CMDBuild.core.constants.Proxy',
			'CMDBuild.proxy.index.Json',
			'CMDBuild.model.administration.dataView.filter.GridStore',
			'CMDBuild.model.administration.dataView.filter.SourceClass'
		],
		...
		getStore: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.DATA_VIEW, {
				autoLoad: false,
				model: 'CMDBuild.model.administration.dataView.filter.GridStore',
				proxy: {
					type: 'ajax',
		...
		getStoreSourceClass: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.CLASS, {
				autoLoad: true,
				model: 'CMDBuild.model.administration.dataView.filter.SourceClass',
				proxy: {
					type: 'ajax',
