(function () {
	...
	Ext.define('CMDBuild.proxy.management.classes.panel.form.tabs.attachments.Attachments', {

		requires: [
			'CMDBuild.core.constants.Proxy',
			'CMDBuild.core.interfaces.FormSubmit',
			'CMDBuild.model.management.classes.panel.form.tabs.attachments.Attachment',
			'CMDBuild.model.management.classes.panel.form.tabs.attachments.window.Lookup',
			'CMDBuild.proxy.index.Json',
			'CMDBuild.proxy.management.classes.panel.form.tabs.attachments.reader.Lookup',
			'CMDBuild.proxy.management.classes.panel.form.tabs.attachments.reader.Reader'
		],
		...
		getStore: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.UNCACHED, { // Uncached because update doesn't go through cache component
				autoLoad: false,
				model: 'CMDBuild.model.management.classes.panel.form.tabs.attachments.Attachment',
				...
				sorters: [
					...
					{ property: CMDBuild.core.constants.Proxy.CREATION_DATE, direction: 'ASC' }
				]
			});
		},
		...
		getStoreLokup: function () {
			return CMDBuild.global.Cache.requestAsStore(CMDBuild.core.constants.Proxy.LOOKUP, {
				autoLoad: true,
				model: 'CMDBuild.model.management.classes.panel.form.tabs.attachments.window.Lookup',
				proxy: {
					type: 'ajax',
