(function () {
	...
	Ext.define('CMDBuild.model.management.dataView.filter.panel.form.tabs.history.CardRecord', {
		...
		fields: [
			...
			{ name: CMDBuild.core.constants.Proxy.VALUES, type: 'auto', defaultValue: {} } // Historic card values
		]
	});
