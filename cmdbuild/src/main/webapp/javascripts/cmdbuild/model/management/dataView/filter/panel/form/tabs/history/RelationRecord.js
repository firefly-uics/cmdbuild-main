(function () {
	...
	Ext.define('CMDBuild.model.management.dataView.filter.panel.form.tabs.history.RelationRecord', {
		...
		fields: [
			...
			{ name: CMDBuild.core.constants.Proxy.VALUES, type: 'auto', defaultValue: {} } // Historic relation values
		]
	});
