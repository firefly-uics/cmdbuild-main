(function () {
	 ...
	 */
	Ext.define('CMDBuild.model.core.buttons.icon.add.relation.Domain', {
		...
		fields: [
			...
			{ name: CMDBuild.core.constants.Proxy.PRIVILEGES, type: 'auto', defaultValue: {} }, // CMDBuild.model.core.buttons.icon.add.relation.Privileges
		...
		constructor: function (data) {
			...
			data[CMDBuild.core.constants.Proxy.PRIVILEGES] = Ext.create('CMDBuild.model.core.buttons.icon.add.relation.Privileges', privilegesObject);
