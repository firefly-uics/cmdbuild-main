(function () {
	 ...
	 * @legacy
	 */
	Ext.define("CMDBuild.controller.management.dataView.filter.panel.form.tabs.attachments.ModifyAttachmentStrategy", {
		...
		doRequest: function(attachmentWindow) {
			...
			CMDBuild.proxy.management.dataView.filter.panel.form.tabs.Attachment.confirm({
				form: form,
