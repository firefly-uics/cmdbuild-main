(function () {
	 ...
	 */
	Ext.define('CMDBuild.controller.management.dataView.filter.panel.override.common.panel.gridAndForm.panel.common.toolbar.Paging', {
		...
		/**
		 * @property {CMDBuild.controller.management.dataView.filter.panel.override.common.panel.gridAndForm.panel.common.filter.advanced.Advanced}
		 */
		controllerFilterAdvanced: undefined,

		/**
		 * @property {CMDBuild.controller.management.dataView.filter.panel.override.common.field.filter.basic.Basic}
		 */
		...
		constructor: function (configurationObject) {
			...
			this.controllerFilterAdvanced = Ext.create('CMDBuild.controller.management.dataView.filter.panel.override.common.panel.gridAndForm.panel.common.filter.advanced.Advanced', { parentDelegate: this });
			this.controllerFilterBasic = Ext.create('CMDBuild.controller.management.dataView.filter.panel.override.common.field.filter.basic.Basic', { parentDelegate: this });

			this.view = Ext.create('CMDBuild.view.common.panel.gridAndForm.panel.common.toolbar.Paging', {
				delegate: this,
				store: this.cmfg('dataViewFilterGridStoreGet'),
				items: [
					{ xtype: 'tbseparator' },
					...
					this.printButton = Ext.create('CMDBuild.core.buttons.icon.split.Print', {
						delegate: this,
						delegateEventPrefix: 'onDataViewFilterGrid',
						formatList: [
