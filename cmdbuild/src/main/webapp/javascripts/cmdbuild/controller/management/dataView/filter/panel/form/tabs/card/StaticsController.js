(function() {
	...
	/**
	 * @link CMDBuild.controller.management.classes.StaticsController
	 */
	Ext.define('CMDBuild.controller.management.dataView.filter.panel.form.tabs.card.StaticsController', {
		...
		getInvalidAttributeAsHTML: function(form) {
			var invalidFields = CMDBuild.controller.management.dataView.filter.panel.form.tabs.card.StaticsController.getInvalidField(form);
			var out = null;
