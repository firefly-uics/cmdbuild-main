(function () {
	 ...
	 * @legacy
	 */
	Ext.define("CMDBuild.controller.management.workflow.panel.form.tabs.attachments.AddAttachmentStrategy", {
		...
		doRequest: function(attachmentWindow) {
			...
			CMDBuild.proxy.management.workflow.panel.form.tabs.Attachment.create({
				form: form,
