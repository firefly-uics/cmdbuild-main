(function () {
	...
	/**
	 * @link CMDBuild.controller.management.classes.attachments.AddAttachmentStrategy
	 * @link CMDBuild.controller.management.classes.attachments.ConfirmAttachmentStrategy
	 *
	 * @legacy
	 */
	Ext.define("CMDBuild.controller.management.dataView.filter.panel.form.tabs.attachments.AddAttachmentStrategy", {
		...
		doRequest: function(attachmentWindow) {
			...
			CMDBuild.proxy.management.dataView.filter.panel.form.tabs.Attachment.create({
				form: form,
