...
public interface NavigationTreeLogic extends Logic {
	...
	void create(final String name, final String description, DomainTreeNode deserialize);

	void save(final String name, final String description, DomainTreeNode deserialize);
